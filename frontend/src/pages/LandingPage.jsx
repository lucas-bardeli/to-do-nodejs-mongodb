...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-between p-4">
      <header className="max-w-4xl mx-auto w-full mb-2">
      ...
      <main className="max-w-4xl mx-auto w-full my-auto py-6 text-center">
        ...
        <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
          Crie tarefas, atribua participantes e discuta o andamento dos projetos
          através do chat integrado em cada atividade.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 text-left">
          ...
          <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-xs">
            ...
            <p className="text-gray-600 text-sm">
              Converse diretamente no contexto da tarefa apenas com as pessoas
              envolvidas nela.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-xs">
            ...
            <p className="text-gray-600 text-sm">
              Sessões protegidas via cookies seguros e controle de acesso
      ...
      <footer className="max-w-4xl mx-auto w-full pt-6 border-t border-gray-200 text-center text-xs text-gray-500">
        &copy; {new Date().getFullYear()} To-Do List Node.js e MongoDB (Lucas
        Bardeli). Todos os direitos reservados.
      </footer>
    </div>
  );
}
